...
static __always_inline bool dissector_new(struct xdp_md *ctx, struct dissector_t *dissector)
{
    dissector->ctx = ctx;
...
static __always_inline bool dissector_find_ip_header(struct dissector_t *dissector)
{
